...
char Menu[] PROGMEM = R"=====(
  ...
  <a href='http://acerna.duckdns.org' target='_blank'>홈피</a>
  </div>
...
char Download[] PROGMEM = R"=====(
  ...
  <br>접속사이트 : <a href='http://acerna.duckdns.org'>http://acerna.duckdns.org/</a>
  <br>
...
void handleConfig() {
  ...
  s+="<br> 아마존 서버 http://acerna.link 접속하려면 회원가입 한 email을 입력하세요.<br>";
  s+="<form action='/on'>";
