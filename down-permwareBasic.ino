...
// 22.10.17 down-permwareBasic test
// 22.10.24 acerna.duckdns.org 생성 AWS public ip 52.78.183.93
#include "FS.h"
...
#include <WebSocketsServer.h>     // ver Websockets ver 2.3.6 by Markus Sattler
#include <Ticker.h>               // ver 4.4.0 by Stefan Staub
#include <PubSubClient.h>         // ver 2.8.0 by Nick O'leary, A client library for MQTT messaging
#include <ArduinoJson.h>          // ver 6.19.4 by Benoit Blanchon
...
// 22.10.17 aws public ip 52.78.183.93
//#define URL_fw_Version "http://52.78.183.93/download/version.txt"
//#define URL_fw_Bin "http://52.78.183.93/download/"
// 22.10.24 acerna.duckdns.org 로 등록
#define URL_fw_Version "http://acerna.duckdns.org/download/version.txt"
#define URL_fw_Bin "http://acerna.duckdns.org/download/"
...
void tick()
{
  ...
  counter++;
  //HTML로 보냄
  String json = "{\"tickcount\":";
  json += counter;
  json += "}";
  webSocket.broadcastTXT(json.c_str(), json.length());

  String s;
  s="tickcount "+(String)counter;
}
